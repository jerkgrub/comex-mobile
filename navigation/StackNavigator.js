...
const StackNavigator = () => {
  ...
  return (
    ...
    >
      ...
      <Stack.Screen
        name="Sustainable Community Programs"
        component={SCProgramsScreen}
      />
      <Stack.Screen name="Partner Communities" component={PartnerComScreen} />
      <Stack.Screen name="Evaluate Us" component={EvaluateUsScreen} />
      <Stack.Screen
        name="BGC Community Outreach"
        component={BGCCommunityOutreachScreen}
      />
      <Stack.Screen
        name="NU Moa Cleanup"
        component={NUMoaCampusCleanupScreen}
      />
